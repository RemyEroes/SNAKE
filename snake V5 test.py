...
class MENU:
    ...
    def draw_snake_preview(self):
        ...
        skin_actuel_rect = skin_actuel.get_rect(
            center=((cell_size*cell_number/2)-20, cell_size*cell_number/2))
    ...
    def draw_fruit_preview(self):
        ...
        # Fruit
        fruit_actuel_rect = fruit_actuel.get_rect(center=((cell_size*cell_number/2)+70, cell_size*cell_number/2))
